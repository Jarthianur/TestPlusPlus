...
TEST_SUITE(test_testsuite_parallel, {
    test("parallel run", [] {
...
TEST_SUITE_PAR(test_stringify, {
    ...
    test("streamable", [] { ASSERT(to_string(1), EQ, std::string("1")); });
})

TEST_SUITE_PAR(test_traits, {
    test("is_streamable", [] {
...
TEST_SUITE_PAR(test_assertions, {
    test("ASSERT", [] {
        // successful
...
TEST_SUITE(test_output_capture, {
    test("single thread", [] {
